...
public class Config implements IConfig {
    ...
    public Context GetContext() {
        ...
        context.vdMan.ActionVD.VDCreate("1", null, new GridLayout());
        context.vdMan.ActionVD.VDCreate("2", null, new GridLayout());
        context.vdMan.ActionVD.VDCreate("3", null, new GridLayout());
        context.vdMan.ActionVD.VDCreate("4", null, new GridLayout());
    ...
    private void ConfigKey(Context context) {
        ...
        context.keyBindMan.Register("Maximize Focused Window and Minimize Others", KeyCode.FuncKey.LALT, KeyCode.VK_Z,
        ...
        for (byte i = 0; i < 9; i++) {
            ...
            context.keyBindMan.Register("Switch Focused Monitor to Virtual Desk " + stri, KeyCode.FuncKey.LALT,
                    KeyCode.VK_1 + i, () -> channelIn.put(new VDManMessage(VDManEvent.SwitchToVD, obji)));
        ...
        context.keyBindMan.Register("Move Focused Window to Next Virtual Desk",
                KeyCode.FuncKey.LALT | KeyCode.FuncKey.LCONTROL | KeyCode.FuncKey.LWIN, KeyCode.VK_RIGHT,
        ...
        context.keyBindMan.Register("Expand the Area of Focused Window", KeyCode.FuncKey.LALT, KeyCode.VK_OEM_PLUS,
                () -> channelIn.put(new VDMessage(VDEvent.AreaExpand, null)));

        context.keyBindMan.Register("Shrink the Area of Focused Window", KeyCode.FuncKey.LALT, KeyCode.VK_OEM_MINUS,
                () -> channelIn.put(new VDMessage(VDEvent.AreaShrink, null)));

        context.keyBindMan.Register("Toggle Tiling State for Focused Window", KeyCode.FuncKey.LALT, KeyCode.VK_T,
                () -> channelIn.put(new VDMessage(VDEvent.ToggleTiling, null)));

        context.keyBindMan.Register("Exit The Program", KeyCode.FuncKey.LALT, KeyCode.VK_Q, () -> context.Exit());
